...
class TWinButton : public TControl
{
public:
...
class TWinListBox : public TControl
{
protected:
...
public:
	...
	TWinListBox(bool multipleSelection = false, bool sort = false, bool vscroll = true);
...
public:
	...
	virtual void add(TWinMenuItem& menuItem);

	virtual void addSubMenu(const TString& text, const TWinMenu& menu);
...
class TWinGridView : public TControl
{
protected:
	int colCount;
	int itemCount;
...
public:
	...
	TWinGridView(bool sortItems = false);
...
class TWinGroupBox : public TControl
{
public:
	TWinGroupBox();
...
class TWinLabel : public TControl
{
public:
	TWinLabel();
...
class TWinPushButton : public TWinCheckBox
{
public:
	TWinPushButton();

	virtual ~TWinPushButton();
};

// =========== TWinRadioButton.h ===========

/*
	MCL - TWinRadioButton.h
	Copyright (C) 2019 CrownSoft
...
class TWinRadioButton : public TWinCheckBox
{
public:
	TWinRadioButton();

	virtual ~TWinRadioButton();
};
...
class TWinTextArea : public TWinEditBox
{
public:
	...
	/**
		(Please override the "Impl" method to change the behaviour!)
	*/
	inline void setEnableVScrollBar(bool enableVScrollBar) { setEnableVScrollBarImpl(enableVScrollBar); }

	/**
		(Please override the "Impl" method to change the behaviour!)
	*/
	inline void setEnableHScrollBar(bool enableHScrollBar) { setEnableHScrollBarImpl(enableHScrollBar); }

	/**
		(Please override the "Impl" method to change the behaviour!)
	*/
	inline void setEnableWordWrap(bool enableWordWrap) { setEnableWordWrapImpl(enableWordWrap); }

	virtual LRESULT windowProcHandler(TMessage& message) override;

	virtual ~TWinTextArea();

private:
	virtual void setEnableVScrollBarImpl(bool enableVScrollBar);
	virtual void setEnableHScrollBarImpl(bool enableHScrollBar);
	virtual void setEnableWordWrapImpl(bool enableWordWrap);
};
...
class TWinNumericField : public TWinEditBox
{
public:
	TWinNumericField();

	virtual ~TWinNumericField();
};
...
class TWinMenuButton : public TWinButton
{
protected:
	TFont* arrowFont;
	HFONT glyphFont;
...
public:
	...
	PROPERTY_DEF_WRITEONLY(TWinMenu&, menu, setMenu)

	TWinMenuButton();

	virtual ~TWinMenuButton();

	/**
		(Please override the "Impl" method to change the behaviour!)
	*/
	inline void setMenu(TWinMenu& buttonMenu_) { setMenuImpl(buttonMenu_); }
...
private:
	virtual void setMenuImpl(TWinMenu& buttonMenu_);
};
...
public:
	...
	virtual void add(const TString& text, const TWinMenu& menu);
